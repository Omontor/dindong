...
class FacturamaController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.facturamas.index', compact('facturamas'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.facturamas.create');
    }
    ...
    public function store(StoreFacturamaRequest $request)
    {
        ...
        return redirect()->route('frontend.facturamas.index');
    }
    ...
    public function edit(Facturama $facturama)
    {
        ...
        return view('frontend.facturamas.edit', compact('facturama'));
    }
    ...
    public function show(Facturama $facturama)
    {
        ...
        return view('frontend.facturamas.show', compact('facturama'));
    }
