...
class MassiveMailController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.massiveMails.index', compact('massiveMails'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.massiveMails.create');
    }
    ...
    public function store(StoreMassiveMailRequest $request)
    {
        ...
        return redirect()->route('frontend.massive-mails.index');
    }
    ...
    public function edit(MassiveMail $massiveMail)
    {
        ...
        return view('frontend.massiveMails.edit', compact('massiveMail'));
    }
    ...
    public function show(MassiveMail $massiveMail)
    {
        ...
        return view('frontend.massiveMails.show', compact('massiveMail'));
    }
