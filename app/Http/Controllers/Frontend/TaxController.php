...
class TaxController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.taxes.index', compact('taxes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.taxes.create');
    }
    ...
    public function store(StoreTaxRequest $request)
    {
        ...
        return redirect()->route('frontend.taxes.index');
    }
    ...
    public function edit(Tax $tax)
    {
        ...
        return view('frontend.taxes.edit', compact('tax'));
    }
    ...
    public function show(Tax $tax)
    {
        ...
        return view('frontend.taxes.show', compact('tax'));
    }
