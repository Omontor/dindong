...
class PaymentFormController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.paymentForms.index', compact('paymentForms'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.paymentForms.create');
    }
    ...
    public function store(StorePaymentFormRequest $request)
    {
        ...
        return redirect()->route('frontend.payment-forms.index');
    }
    ...
    public function edit(PaymentForm $paymentForm)
    {
        ...
        return view('frontend.paymentForms.edit', compact('paymentForm'));
    }
    ...
    public function show(PaymentForm $paymentForm)
    {
        ...
        return view('frontend.paymentForms.show', compact('paymentForm'));
    }
