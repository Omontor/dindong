...
class ProductCodeController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.productCodes.index', compact('productCodes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.productCodes.create');
    }
    ...
    public function store(StoreProductCodeRequest $request)
    {
        ...
        return redirect()->route('frontend.product-codes.index');
    }
    ...
    public function edit(ProductCode $productCode)
    {
        ...
        return view('frontend.productCodes.edit', compact('productCode'));
    }
    ...
    public function show(ProductCode $productCode)
    {
        ...
        return view('frontend.productCodes.show', compact('productCode'));
    }
