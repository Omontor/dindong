...
class RelatedVoucherController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.relatedVouchers.index', compact('relatedVouchers'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.relatedVouchers.create');
    }
    ...
    public function store(StoreRelatedVoucherRequest $request)
    {
        ...
        return redirect()->route('frontend.related-vouchers.index');
    }
    ...
    public function edit(RelatedVoucher $relatedVoucher)
    {
        ...
        return view('frontend.relatedVouchers.edit', compact('relatedVoucher'));
    }
    ...
    public function show(RelatedVoucher $relatedVoucher)
    {
        ...
        return view('frontend.relatedVouchers.show', compact('relatedVoucher'));
    }
