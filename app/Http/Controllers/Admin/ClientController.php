...
class ClientController extends Controller
{
    public function index()
    {
        ...
        return view('admin.clients.index', compact('clients', 'countries', 'municipalities', 'states', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.clients.create', compact('countries', 'municipalities', 'states'));
    }
    ...
    public function edit(Client $client)
    {
        ...
        return view('admin.clients.edit', compact('countries', 'municipalities', 'states', 'client'));
    }
