...
class QuotesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.quotes.index', compact('quotes', 'clients', 'products', 'taxes', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.quotes.create', compact('clients', 'products', 'taxes'));
    }
    ...
    public function edit(Quote $quote)
    {
        ...
        return view('admin.quotes.edit', compact('clients', 'products', 'taxes', 'quote'));
    }
