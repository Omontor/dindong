...
class InvoiceSerieController extends Controller
{
    public function index()
    {
        ...
        return view('admin.invoiceSeries.index', compact('invoiceSeries'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.invoiceSeries.create');
    }
    ...
    public function store(StoreInvoiceSerieRequest $request)
    {
        ...
        return redirect()->route('admin.invoice-series.index');
    }
    ...
    public function edit(InvoiceSerie $invoiceSerie)
    {
        ...
        return view('admin.invoiceSeries.edit', compact('invoiceSerie'));
    }
    ...
    public function show(InvoiceSerie $invoiceSerie)
    {
        ...
        return view('admin.invoiceSeries.show', compact('invoiceSerie'));
    }
