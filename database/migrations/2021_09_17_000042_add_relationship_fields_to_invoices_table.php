...
class AddRelationshipFieldsToInvoicesTable extends Migration
{
    public function up()
    {
        Schema::table('invoices', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('paid_form_id')->nullable();
            ...
            $table->unsignedBigInteger('cfdi_use_id')->nullable();
            ...
            $table->foreign('serie_id', 'serie_fk_4901697')->references('id')->on('invoice_series');
