                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="{{ route("frontend.user-infos.update", [$userInfo->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="rfc" id="rfc" value="{{ old('rfc', $userInfo->rfc) }}" required>
                            @if($errors->has('rfc'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('rfc') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="regimen" id="regimen" required>
                                @foreach($regim as $id => $entry)
                                    <option value="{{ $id }}" {{ old('regimen') == $id ? 'selected' : '' }}>{{ $entry->name}}</option>
                                @endforeach
                            </select>
                            @if($errors->has('regim'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="legal_name" id="legal_name" value="{{ old('legal_name', $userInfo->legal_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address_1" id="address_1" required>{{ old('address_1', $userInfo->address_1) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="addres_2" id="addres_2" value="{{ old('addres_2', $userInfo->addres_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="postal_code" id="postal_code" value="{{ old('postal_code', $userInfo->postal_code) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password" id="password" value="{{ old('password', $userInfo->password) }}" required>
