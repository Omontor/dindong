                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.quotes.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="conditions" id="conditions">{!! old('conditions') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="expiracy" id="expiracy" value="{{ old('expiracy') }}" required>
