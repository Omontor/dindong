    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.quotes.update", [$quote->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('conditions') ? 'is-invalid' : '' }}" name="conditions" id="conditions">{!! old('conditions', $quote->conditions) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('expiracy') ? 'is-invalid' : '' }}" type="text" name="expiracy" id="expiracy" value="{{ old('expiracy', $quote->expiracy) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" type="text" name="total" id="total" value="{{ old('total', $quote->total) }}" required>
                @if($errors->has('total'))
